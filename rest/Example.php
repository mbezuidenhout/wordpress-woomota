...
namespace Tasmota_Device_Manager\Rest;
...
class Example extends Base {
	...
	public function get_text_field( array $post_obj ) {
		...
		return \get_post_meta( $post_id, TDM_TEXTDOMAIN . '_text', true );
	}
	...
	public function update_text_field( string $value, \WP_Post $post, string $key ) {
		...
		if ( false === $post_id ) {
			return new \WP_Error(
				...
				\__( 'Failed to update post views.', TDM_TEXTDOMAIN ),
				array( 'status' => 500 )
			);
		}
