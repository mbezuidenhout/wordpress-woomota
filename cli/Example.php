...
namespace Tasmota_Device_Manager\Cli;
...
if ( \defined( 'WP_CLI' ) && WP_CLI ) {
	...
	class Example extends Base {
		...
		public function __construct() {
			\WP_CLI::add_command( 'tdm_commandname', array( $this, 'command_example' ) );
		}
		...
		public function initialize() {
			if ( !\apply_filters( 'tasmota_device_manager_tdm_enqueue_admin_initialize', true ) ) {
				return;
			}
